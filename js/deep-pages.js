  ...
  render() {
    ...
    fetch('../js/learn-pages.json')
      ...
      .then(data => {
        ...
        if (!page) {
          document.getElementById('deepContent').innerHTML = '<h1>Page not found</h1><p style="color:var(--text-secondary);margin:1rem 0;">The page you requested doesn\'t exist yet.</p><a href="../index.html#learn" class="back-link">← Back to Learn</a>';
          return;
        }
        ...
        page.sections.forEach((s, i) => {
          ...
          // Italic (*text*) - only match single asterisks not part of **
